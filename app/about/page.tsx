    ...
    <div className="container max-w-6xl py-6 lg:py-10">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
        ...
        <p className="text-muted-foreground text-lg py-4">
          ...
          designing and optimizing web applications, with a focus on e-commerce solutions. Proficient in industry best
          practices and design patterns for high-quality software delivery.
        </p>
      </div>
    </div>
  );
